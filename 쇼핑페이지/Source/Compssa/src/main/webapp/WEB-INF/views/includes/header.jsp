...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href=/main/main>
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Compssa</div>
            </a>
             ...
             <c:forEach items="${categoryList}" var="category" varStatus="loop">
				<c:set var = "parentID" value = "${category.parentID}"/>
             	<c:if test="${parentID eq 0}">
		        	<li class="nav-item">
		                <a class="nav-link" href="main/main" data-toggle="collapse" data-target="#collapse_${loop.count}"
            ...
            <li class="nav-item">
			 ...
			 <li class="nav-item">
				<sec:authorize access="isAuthenticated()">
					<a class="nav-link" href="/member/customLogout">Logout
						<span class="sr-only">(current)</span>
					</a>
				</sec:authorize>
			        
				<sec:authorize access="isAnonymous()">
					<a class="nav-link" href="/member/customLogin">Login
			   			<span class="sr-only">(current)</span>
			   		</a>
			 	</sec:authorize>
			</li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form id='searchForm' action="/product/productList" method='get' class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..."
                                aria-label="Search" aria-describedby="basic-addon2" name='keyword' value='<c:out value="${keyword}"/>'>
